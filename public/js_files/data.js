document.getElementById('subjects').addEventListener("click", async () => {
    // let data = {
...
document.getElementById('trials').addEventListener("click", async () => {
    // let data = {
    //     credentials: "Em@nate_UCSD-Hp_Game"
    // }
    // very rudamentary form check but quick and gets job done
    ...
    const res = await fetch('/api/trial', options)
    const json = await res.json();
    // console.log(json)
